		      	...
		      	<div class="card panel-default">
			        ...
			        <div class="card-body">
			         	<div class="photo_info disflex">
	                        ...
	                        <div class="user-info">
	                            <p><span>{{ __("shop.info.name") }}:</span><span class="info">{{ Auth::user()->name }}</span><a href="{{ url('/user_info/edit') }}">{{ __("shop.info.editinfo") }}</a></p>
	                            <p><span>{{ __("shop.info.email") }}:</span><span class="info">{{ Auth::user()->email }}</span><a href="{{ url('/user_info/change_email') }}">{{ __("shop.info.editemail") }}</a></p>
	                            <p><span>{{ __("shop.info.pass") }}:</span><span class="info">********</span><a href="{{ url('/user_info/pass') }}">{{ __("shop.info.editpass") }}</a></p>
	                            @if(Auth::user()->phone)
